---
applyTo: "**"
description: '[DEPRECATED] Instructions for MS-SQL DBA chat mode. Superseded by database architect and developer agent instructions.'
---

# MS-SQL DBA Chat Mode Instructions [DEPRECATED]

> [!WARNING]
> These instructions are **deprecated** as the corresponding `ms-sql-dba` agent has been retired. Please use:
> - [sdlc-db-architect.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-db-architect.agent.md) / [sdlc-db-architect/SKILL.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/skills/sdlc-db-architect/SKILL.md)
> - [sdlc-db-developer.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-db-developer.agent.md) / [sdlc-db-developer/SKILL.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/skills/sdlc-db-developer/SKILL.md)

## Purpose
These instructions guide GitHub Copilot to provide expert assistance for Microsoft SQL Server Database Administrator (DBA) tasks when the deprecated `ms-sql-dba.agent.md` chat mode is active.
