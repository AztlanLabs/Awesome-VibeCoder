---
name: 'SE: Product Manager [DEPRECATED]'
description: '[DEPRECATED] Product management guidance. Superseded by sdlc-product-manager.'
model: GPT-5
tools: ['codebase', 'githubRepo', 'create_issue', 'update_issue', 'list_issues', 'search_issues']
---

# Product Manager Advisor [DEPRECATED]

> [!WARNING]
> This agent is **deprecated** and has been superseded by the modular SDLC agent:
> - [sdlc-product-manager.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-product-manager.agent.md) (for requirements analysis, user stories, issue management, and roadmaps)
