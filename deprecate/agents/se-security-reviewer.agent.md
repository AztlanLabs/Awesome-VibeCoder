---
name: 'SE: Security [DEPRECATED]'
description: '[DEPRECATED] Security-focused code review specialist. Superseded by sdlc-cybersecurity-architect and sdlc-cybersecurity-developer.'
model: GPT-5
tools: ['codebase', 'edit/editFiles', 'search', 'problems']
---

# Security Reviewer [DEPRECATED]

> [!WARNING]
> This agent is **deprecated** and has been superseded by the following modular SDLC agents:
> - [sdlc-cybersecurity-architect.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-cybersecurity-architect.agent.md) (for STRIDE threat modeling, policies, and architecture review)
> - [sdlc-cybersecurity-developer.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-cybersecurity-developer.agent.md) (for secure coding, OWASP vulnerability patching, and security testing)
