---
name: 'SE: Responsible AI [DEPRECATED]'
description: '[DEPRECATED] Responsible AI specialist. Superseded by sdlc-responsible-ai.'
model: GPT-5
tools: ['codebase', 'edit/editFiles', 'search']
---

# Responsible AI Specialist [DEPRECATED]

> [!WARNING]
> This agent is **deprecated** and has been superseded by the modular SDLC agent:
> - [sdlc-responsible-ai.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-responsible-ai.agent.md) (for bias prevention, accessibility compliance, privacy-by-design, and ethics reviews)
