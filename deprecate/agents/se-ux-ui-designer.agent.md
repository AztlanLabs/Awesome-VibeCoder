---
name: 'SE: UX Designer [DEPRECATED]'
description: '[DEPRECATED] Jobs-to-be-Done analysis, user journey mapping, and UX research. Superseded by sdlc-ux-ui-designer.'
model: GPT-5
tools: ['codebase', 'edit/editFiles', 'search', 'web/fetch']
---

# UX/UI Designer [DEPRECATED]

> [!WARNING]
> This agent is **deprecated** and has been superseded by the modular SDLC agent:
> - [sdlc-ux-ui-designer.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-ux-ui-designer.agent.md) (for JTBD analysis, user journeys, wireframe specs, and design systems)
