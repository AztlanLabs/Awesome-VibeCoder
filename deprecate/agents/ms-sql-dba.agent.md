---
description: "[DEPRECATED] Work with Microsoft SQL Server databases. Superseded by sdlc-db-architect and sdlc-db-developer."
name: "MS-SQL Database Administrator [DEPRECATED]"
...
# MS-SQL Database Administrator [DEPRECATED]

> [!WARNING]
> This agent is **deprecated** and has been superseded by the following modular SDLC agents:
> - [sdlc-db-architect.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-db-architect.agent.md) (for data modeling, schema design, ERDs, and migration plans)
> - [sdlc-db-developer.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-db-developer.agent.md) (for queries, stored procedures, migration scripts, and optimization)
