---
description: '[DEPRECATED] Expert-level software engineering agent. Superseded by sdlc-developer and sdlc-fullstack-engineer.'
name: 'Software Engineer Agent [DEPRECATED]'
tools: ['changes', 'search/codebase', 'edit/editFiles', 'extensions', 'web/fetch', 'findTestFiles', 'githubRepo', 'new', 'openSimpleBrowser', 'problems', 'runCommands', 'runTasks', 'runTests', 'search', 'search/searchResults', 'runCommands/terminalLastCommand', 'runCommands/terminalSelection', 'testFailure', 'usages', 'vscodeAPI', 'github']
---
# Software Engineer Agent v1 [DEPRECATED]

> [!WARNING]
> This agent is **deprecated** and has been superseded by the following modular SDLC agents:
> - [sdlc-developer.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-developer.agent.md) (for implementation, refactoring, and general programming tasks)
> - [sdlc-fullstack-engineer.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/sdlc-fullstack-engineer.agent.md) (for features spanning frontend UI and backend API layers)
