---
description: '[DEPRECATED] Expert prompt engineering and validation system. Superseded by PromptFileAuthor.'
name: 'Prompt Builder [DEPRECATED]'
...
# Prompt Builder [DEPRECATED]

> [!WARNING]
> This agent is **deprecated** and has been superseded by the Prompt File Author agent:
> - [PromptFileAuthor.agent.md](file:///home/crowne/Documents/Documents/VS%20Code/Awesome-VibeCoder/agents/PromptFileAuthor.agent.md) (for creating, rewriting, and sanitizing prompt files)
